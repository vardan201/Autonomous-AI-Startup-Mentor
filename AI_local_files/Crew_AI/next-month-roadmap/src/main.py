        ...
        try:
            ...
            if "rate_limit" in error_msg.lower() or "RateLimitError" in error_msg:
                if attempt < max_retries - 1:
                    ...
                    print("2. Use a faster model with higher limits (e.g., llama-3.1-8b-instant)")
                    print("3. Consider upgrading your Groq plan at https://console.groq.com/settings/billing")
                    raise Exception(f"Rate limit error after {max_retries} attempts: {e}")
            else:
